...
export type Profile = Database['public']['Tables']['profiles_drugcupsabot']['Row'];
...
export type Requisition = Database['public']['Tables']['requisitions_drugcupsabot']['Row'];
export type RequisitionItem = Database['public']['Tables']['requisition_items_drugcupsabot']['Row'];
export type PcuPersonnel = Database['public']['Tables']['pcu_personnel_drugcupsabot']['Row'];
